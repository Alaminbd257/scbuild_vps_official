...
post_reboot() {
  echo 'wget -O /root/install.sh "https://raw.githubusercontent.com/Alaminbd257/scbuild_vps_official/main/installer/install-without-key.sh"; clear; sleep 2; chmod +x /root/install.sh; /root/install.sh --continue' >>/root/.bashrc
...
clear && clear
msg -bar2
echo -e " \e[5m\033[1;100m   =====>> ►► 🐲 Scbuild VPS - SCRIPT  🐲 ◄◄ <<=====   \033[1;37m"
msg -bar2
print_center -ama "AVAILABLE SCRIPT LIST"
msg -bar
#-BASH SOPORTE ONLINE
wget https://raw.githubusercontent.com/Alaminbd257/scbuild_vps_official/main/LINKS-LIBRARIES/SPR.sh -O /usr/bin/SPR >/dev/null 2>&1
chmod +x /usr/bin/SPR
...
install_official() {
  ...
  cd /etc
  wget https://raw.githubusercontent.com/Alaminbd257/scbuild_vps_official/main/SCRIPT-v8.5x/VPS-AGN.tar.xz >/dev/null 2>&1
  ...
  wget https://raw.githubusercontent.com/Alaminbd257/scbuild_vps_official/main/LINKS-LIBRARIES/monitor.sh -P /bin/
  ...
  wget -O /bin/resetsshdrop https://raw.githubusercontent.com/Alaminbd257/scbuild_vps_official/main/LINKS-LIBRARIES/resetsshdrop &>/dev/null
